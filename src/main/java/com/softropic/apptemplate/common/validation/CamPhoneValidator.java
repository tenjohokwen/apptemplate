package com.softropic.apptemplate.common.validation;
...
public class CamPhoneValidator implements ConstraintValidator<CamPhone, String> {
     ...
     */
    private String[] mapErrorCodeToMessage(com.softropic.apptemplate.common.exception.ErrorCode errorCode) {
        if (errorCode == null) {
