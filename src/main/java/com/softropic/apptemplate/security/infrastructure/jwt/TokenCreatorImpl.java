...
import static com.softropic.apptemplate.security.contract.exception.SecurityError.FAULTY_JWT_ROLES_CLAIMS;
...
public class TokenCreatorImpl implements TokenCreator {
    ...
    private String getClientId(final boolean isLoggedIn) {
        ...
        throw new com.softropic.apptemplate.security.contract.exception.MissingClientIdException(msg);
    }
}
