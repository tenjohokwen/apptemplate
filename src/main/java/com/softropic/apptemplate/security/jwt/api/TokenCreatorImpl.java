...
import static com.softropic.apptemplate.security.exposed.exception.SecurityError.FAULTY_JWT_ROLES_CLAIMS;
...
public class TokenCreatorImpl implements TokenCreator {
    ...
    private String getClientId(final boolean isLoggedIn) {
        ...
        throw new com.softropic.apptemplate.security.exposed.exception.MissingClientIdException(msg);
    }
}
