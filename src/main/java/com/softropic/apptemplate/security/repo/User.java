...
public class User extends Customer implements Serializable {
     ...
     *
     * @throws com.softropic.apptemplate.security.contract.exception.UserAlreadyActivatedException if user is already activated
     */
    public void activate() {
        if (this.activated) {
            throw new com.softropic.apptemplate.security.contract.exception.UserAlreadyActivatedException(
     ...
     * @throws com.softropic.apptemplate.security.contract.exception.UserNotActivatedException if account is not activated
     * @throws com.softropic.apptemplate.security.contract.exception.UserAccountLockedException if account is locked
     */
    public void preparePasswordReset(String resetKey, long expirationHours) {
        if (!this.activated) {
            throw new com.softropic.apptemplate.security.contract.exception.UserNotActivatedException(
                "Cannot reset password for inactive account", this.login);
        }
        if (this.locked) {
            throw new com.softropic.apptemplate.security.contract.exception.UserAccountLockedException(
     ...
     * @throws com.softropic.apptemplate.security.contract.exception.UserAccountLockedException if account is locked
     * @throws com.softropic.apptemplate.security.contract.exception.PasswordResetExpiredException if reset key has expired
     */
    public void completePasswordReset(String newPasswordHash) {
        ...
        if (this.resetExpiration == null ||
            ...
            throw new com.softropic.apptemplate.security.contract.exception.PasswordResetExpiredException(
